...
class TestRegex(unittest.TestCase):
    ...
    def testReplace(self):
        ...
        self.assertTrue("XXXX-XXXX-XXXX-5555" in ccnReplace(text))
        self.assertTrue("XXXX-XXXX-XXXX-5678" in ccnReplace(text))
        
    def testSkip(self):
        "Make sure the function doesn't replace other numbers, like phone numbers."
        self.assertTrue("555-123-4567" in ccnReplace(text))
        self.assertFalse("XXX-XXX-4567" in ccnReplace(text))
